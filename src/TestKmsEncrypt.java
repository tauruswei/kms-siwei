...
public class TestKmsEncrypt {

    public static void test(KMS_SIWEI kms_siwei, String para_kmsuser,String para_kmspassword,String para_name,String para_plainPath,String para_encryptPathint,int threadNum, int count) {

        new Thread(new TPSPrint(KmsEncrypt.class, "KmsEncrypt")).start();
        //启动停止线程
        new Thread(new StopTest(KmsEncrypt.class, TPSPrint.class)).start();
        for (int i = 0; i < threadNum; i++) {
            new Thread(new KmsEncrypt(kms_siwei, para_kmsuser, para_kmspassword, para_name,para_plainPath,para_encryptPathint, count)).start();
        }
...
//    }
     ...
     * @author
     */
    public static class KmsEncrypt implements Runnable {
        ...
        public KmsEncrypt(KMS_SIWEI kms_siwei, String para_kmsuser,String para_kmspassword,String para_name,String para_plainPath,String para_encryptPathint, int count) {
            okCount = 0;
            failCount = 0;
            exCount = 0;
            running = true;
            ...
            this.para_encryptPath = para_encryptPathint;
        ...
        public void run() {
            ...
            while ((running)) {
                try {
                    ...
                    Result result = kms_siwei.encrypt(para_plainPath, para_encryptPath, (String) weitest5.getData());
